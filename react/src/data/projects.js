...
const allProjects = [
  ...
  {
    id: 'ai-knowledge-base-engineering',
    title: 'AI Knowledge Base for Engineering',
    category: 'design',
    tags: ['UX Design', 'Knowledge Systems', 'AI'],
    year: '2026',
    location: 'Freelance',
    cover: '/img/ai-knowledge-base-cover.svg',
    placeholderLabel: null,
    description:
      'A knowledge system that helps engineering teams find standards, patterns, and answers — with AI-assisted search and curated structure.',
    demoUrl: null,
    repoUrl: null,
    externalUrl: null,
    modalImage: null,
    modalTech: 'Information architecture · AI search · Knowledge systems',
    tools: ['Figma', 'IA', 'User research', 'Prototyping'],
  ...
  },
  {
    ...
    externalUrl: null,
    modalImage: null,
    modalTech: 'Intake flows · Status model · Collaboration',
    tools: ['Figma', 'Service design', 'Workshops', 'Prototyping'],
    passwordProtected: true,
  },
  {
