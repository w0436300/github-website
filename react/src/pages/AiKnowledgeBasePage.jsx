...
function CaseStudyContent() {
  ...
  return <main className="case-study-page min-h-screen bg-white text-slate-900 pb-24" style={openSans}>
    <section id="Overview" className="px-6 pt-6 pb-16 md:pt-12"><div className="mx-auto max-w-7xl">
      ...
      <ProductImage className="mt-8" src={img('home.png')} alt="Knowledge Hub home with ask field, pinned sources, and recent conversations" caption="The home screen combines quick AI entry, pinned standards, and resumable conversations—without forcing one starting path." />
    </div></section>
