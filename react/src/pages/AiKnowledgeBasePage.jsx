...
function AbstractSearchUi() {
  return (
    <svg viewBox="0 0 640 280" className="w-full h-auto border border-orange-100 bg-white" fill="none" aria-hidden>
      <rect x="16" y="16" width="140" height="248" fill="#fff7ed" stroke="#ffedd5" />
      ...
      <rect x="176" y="58" width="432" height="36" rx="2" fill="#fffaf5" stroke="#fed7aa" />
      <rect x="188" y="70" width="200" height="8" rx="1" fill="#94a3b8" />
      <rect x="176" y="112" width="210" height="88" rx="2" fill="#fff" stroke="#ffedd5" />
      ...
      <rect x="400" y="112" width="208" height="88" rx="2" fill="#fff" stroke="#ffedd5" />
...
function CaseStudyContent() {
  return (
    <div className="case-study-page min-h-screen bg-white text-slate-900 selection:bg-orange-200 scroll-smooth pb-20" style={openSans}>
      <section id="Overview" className="pt-2 pb-10 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap items-center gap-2 mb-3 text-[10px] uppercase tracking-widest text-slate-600">
            ...
            <span className="inline-flex items-center gap-1 border border-orange-100 px-2 py-0.5 text-slate-700">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-0 border border-orange-100 overflow-hidden text-[13px] bg-white mb-10">
            {[
              ...
              <div key={k} className="border-r border-b border-orange-100 p-3 last:border-r-0 md:[&:nth-child(4n)]:border-r-0">
      ...
      <section id="Problem" className="py-12 px-6 border-t border-orange-100">
        <div className="max-w-7xl mx-auto">
          <SectionIntro
            eyebrow="Problem"
          ...
          />
          <div className="grid md:grid-cols-3 gap-0 border border-orange-100">
            {[
              ...
              <div key={t} className="border-r border-b border-orange-100 p-5 last:border-r-0 md:[&:nth-child(3n)]:border-r-0">
      ...
      <section id="Approach" className="py-12 px-6 border-t border-orange-100">
        <div className="max-w-7xl mx-auto">
          <SectionIntro
            eyebrow="Approach"
          ...
          <ol className="space-y-4">
            {[
              ...
              <li key={t} className="flex gap-4 border border-orange-100 p-4 bg-white">
      ...
      <section id="Outcome" className="py-12 px-6 border-t border-orange-100">
        <div className="max-w-7xl mx-auto">
          <SectionIntro
            eyebrow="Outcome"
