    ...
    <section id="home" className="px-6 md:px-12 lg:px-20 pt-4 md:pt-4 pb-24 md:pb-32 bg-white">
      ...
      <div className="mb-2">
        ...
        <h1
          ...
          style={sourceSansPro}
        >
          I&apos;m Xinping (Claire), a product designer bridging <span className="text-[#4F719A]">design</span> and <span className="text-[#4F719A]">engineering</span>.
        </h1>
        ...
        <div className="space-y-0 mb-6 max-w-4xl border-gray-200 pb-6">
          {SKILL_ROWS.map((row) => (
            <p key={row.label} className="text-regular leading-snug">
              <span className="text-gray-800 font-medium uppercase tracking-wider border-l-4 border-gray-700 pl-2">
                {row.label}
